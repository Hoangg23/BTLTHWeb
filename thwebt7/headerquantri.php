            ...
            <div class="grid wide">
                <div class="manager-form">
                    ...
                    <div class="manager-form__wrap">
                      <a href="index.php">  <h3 class="manager-form__menu-heading">Trang Người Dùng</h3></a>
                    </div>
                    <div class="manager-form__wrap">
                    ...
                    <div class="manager-form__wrap">
                       <a href="sanpham_nhom.php"> <h3 class="manager-form__menu-heading">Hãng Sản Phẩm <i class="fa-solid fa-circle-chevron-down"></i></h3></a>
                        <div class="manager-form__menu">
                            <ul class="manager-form__menu-list">
                                <li class="manager-form__menu-items">
                                    <a href="sanpham_nhom.php" class="manager-form__menu-items-link">Các Hãng Sản Phẩm</a>
                                    </li>
                                <li class="manager-form__menu-items">
                                    <a href="formsanpham_nhom.php" class="manager-form__menu-items-link">Thêm Hãng Sản Phẩm</a>
                                    </li>
                            </ul>
                        </div>
                    </div>
                    <div class="manager-form__wrap">
                      <a href="baocaothongke.php">  <h3 class="manager-form__menu-heading">Doanh Thu</h3></a>
                    </div>
                </div>
            </div>
        </div>
